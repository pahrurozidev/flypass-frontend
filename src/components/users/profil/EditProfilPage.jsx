                        ...
                        <form onSubmit={(e) => submit(e)} className="d-md-flex gap-md-5">
                            ...
                            <div className='col'>
                                ...
                                <div className='mb-0 d-md-flex justify-content-end mt-4 mt-md-5'>
                                    <div className='btn btn-primary d-flex gap-1 justify-content-center shadow'>
                                        <button type="submit" name='submit' className="btn btn-primary" style={{ width: "80px", height: "32px" }}>Save</button>
                                    </div>
                                </div>
                            </div>
                        </form>
