            ...
            <div className='container-fluid pb-5'>
                <div className='admin-content px-lg-2'>
                    ...
                    <div className='border rounded px-2 pt-md-3 px-md-3 pb-1 pt-3'>
                        ...
                        <p className='header-text fw-light col-12 col-lg-9'>Halaman ini menampilkan list transaksi dari semua customer.</p>
                    </div>
                                        ...
                                        {[...bookings].reverse().map((booking) => (
                                            <tr key={booking.id}>
                                                ...
                                                <td data-label="Action" className="td_action">
                                                    <Link to={`/transaction/${booking.id}`} className="detail_transaction">
                    ...
                    {bookings.length == 0 && <NotFound alert={'Transactions'} />}
                </div>
            </div>
